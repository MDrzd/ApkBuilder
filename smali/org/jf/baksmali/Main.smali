.class public Lorg/jf/baksmali/Main;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lorg/jf/baksmali/Main;->loadVersion()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/jf/baksmali/Main;->VERSION:Ljava/lang/String;
...
.method private static loadVersion()Ljava/lang/String;
    ...
    const-class v0, Lorg/jf/baksmali/Baksmali;

    invoke-virtual {v0}, Ljava/lang/Class;->getClassLoader()Ljava/lang/ClassLoader;

    move-result-object v0

    const-string v1, "baksmali.properties"
...
.method public static main([Ljava/lang/String;)V
    ...
    new-instance v0, Lorg/jf/baksmali/Main;

    invoke-direct {v0}, Lorg/jf/baksmali/Main;-><init>()V
    ...
    iput-object v1, v0, Lorg/jf/baksmali/Main;->jc:Lcom/beust/jcommander/JCommander;

    const-string v2, "baksmali"

    invoke-virtual {v1, v2}, Lcom/beust/jcommander/JCommander;->setProgramName(Ljava/lang/String;)V

    invoke-virtual {v0}, Lorg/jf/baksmali/Main;->getCommandHierarchy()Ljava/util/List;

    move-result-object v2

    new-instance v3, Lorg/jf/baksmali/DisassembleCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/DisassembleCommand;-><init>(Ljava/util/List;)V
    ...
    new-instance v3, Lorg/jf/baksmali/DeodexCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/DeodexCommand;-><init>(Ljava/util/List;)V

    invoke-static {v1, v3}, Lorg/jf/util/jcommander/ExtendedCommands;->addExtendedCommand(Lcom/beust/jcommander/JCommander;Lorg/jf/util/jcommander/Command;)V

    new-instance v3, Lorg/jf/baksmali/DumpCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/DumpCommand;-><init>(Ljava/util/List;)V

    invoke-static {v1, v3}, Lorg/jf/util/jcommander/ExtendedCommands;->addExtendedCommand(Lcom/beust/jcommander/JCommander;Lorg/jf/util/jcommander/Command;)V

    new-instance v3, Lorg/jf/baksmali/HelpCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/HelpCommand;-><init>(Ljava/util/List;)V

    invoke-static {v1, v3}, Lorg/jf/util/jcommander/ExtendedCommands;->addExtendedCommand(Lcom/beust/jcommander/JCommander;Lorg/jf/util/jcommander/Command;)V

    new-instance v3, Lorg/jf/baksmali/HelpCommand$HlepCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/HelpCommand$HlepCommand;-><init>(Ljava/util/List;)V

    invoke-static {v1, v3}, Lorg/jf/util/jcommander/ExtendedCommands;->addExtendedCommand(Lcom/beust/jcommander/JCommander;Lorg/jf/util/jcommander/Command;)V

    new-instance v3, Lorg/jf/baksmali/ListCommand;

    invoke-direct {v3, v2}, Lorg/jf/baksmali/ListCommand;-><init>(Ljava/util/List;)V

    invoke-static {v1, v3}, Lorg/jf/util/jcommander/ExtendedCommands;->addExtendedCommand(Lcom/beust/jcommander/JCommander;Lorg/jf/util/jcommander/Command;)V

    invoke-virtual {v1, p0}, Lcom/beust/jcommander/JCommander;->parse([Ljava/lang/String;)V

    iget-boolean p0, v0, Lorg/jf/baksmali/Main;->version:Z

    if-eqz p0, :cond_0

    invoke-static {}, Lorg/jf/baksmali/Main;->version()V
    ...
    iget-boolean p0, v0, Lorg/jf/baksmali/Main;->help:Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {v0}, Lorg/jf/baksmali/Main;->usage()V
...
.method protected static version()V
    ...
    sget-object v2, Lorg/jf/baksmali/Main;->VERSION:Ljava/lang/String;
...
.method protected getJCommander()Lcom/beust/jcommander/JCommander;
    ...
    iget-object v0, p0, Lorg/jf/baksmali/Main;->jc:Lcom/beust/jcommander/JCommander;
